...
# === CONFIGURATION ===
# Explicitly target the take-home folder on Desktop
BASE_DIR = Path.home() / "Desktop/stemday_takehome"
...
SERVER_PY = BASE_DIR / "web_version_admin/server.py"  # ✅ Lock to take-home
...
from flag_generators.gen_17_nmap_scanning import generate_flag as gen_17  # May modify server.py
...
GENERATOR_MAP = {
    ...
    "17_Nmap_Scanning": gen_17,  # ✅ This generator touches server.py
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate flags for the take-home bundle.")
